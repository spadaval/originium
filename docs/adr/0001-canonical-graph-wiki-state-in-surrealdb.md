...
canonical evidence, Source Headings should store navigational metadata, Source
Text Projections may store lossy extracted text as rebuildable search caches,
and Wiki Pages should store synthesis prose plus graph-backed Citations.
Projection rows may be indexed and embedded, but citation evidence still points
back to Source Documents through Source Headings or other Source Anchors. The
